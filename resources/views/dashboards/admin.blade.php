        ...
        <div class="col-md-3">
            <div class="card h-100 border-0 shadow-sm border-start border-warning border-4">
                <div class="card-body p-4 position-relative">
                    ...
                    <div class="text-warning small mt-2 fw-bold">Awaiting Delivery</div>
        ...
        <div class="col-md-3">
            <div class="card h-100 border-0 shadow-sm border-start border-info border-4">
                <div class="card-body p-4 position-relative">
                    ...
                    <div class="text-info small mt-2 fw-bold">Awaiting Invoice</div>
        ...
        <div class="col-md-3">
            <div class="card h-100 border-0 shadow-sm border-start border-success border-4">
                <div class="card-body p-4 position-relative">
                    ...
                    <div class="text-success small mt-2 fw-bold">Completed / Paid</div>
